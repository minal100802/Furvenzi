...
<head>
  ...
  <link rel="stylesheet" href="signin(en).css">
...
<body>
  ...
  <div id="login-box">
    <div class="right">
      ...
      <div class="input-box">
        <input class="text" type="text" name="email" placeholder="Enter your email or mobile number" />
      ...
      <a class="fp-link" href="rp.html">Forgot Password ?</a>
      <input class="submit-button" type="submit" name="signup_submit" value="Sign-In"/>
      <label class="sign-in-link">New to Furvenzi ?<a class="sign-link" href="../Signup/signup(en)1.php">Sign-Up</a></label>
    </div>
    </form>
    <div class="left">
      <div class="lefttxt">
