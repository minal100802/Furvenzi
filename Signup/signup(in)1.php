  ...
  <div id="login-box">
    <div class="right">
      ...
      <div class = "form">
        ...
        <div class="input-box">
          <input class="firstname" type="text" name="first_name" placeholder="First Name" /><input class="lastname"
          ...
          <input class="resi-add" type="text" name="address" placeholder="Residential Address" />
        </div>
      </div>  
      ...
      <label class="sign-in-link">Already a member ?<a class="sign-link" href="../Signin/signin(in).php">Sign-In</a></label>
    </div>
    <div class="left">
      <div class="lefttxt">
